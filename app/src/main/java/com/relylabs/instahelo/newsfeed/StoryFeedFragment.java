...
import com.relylabs.instahelo.UserProfileFragment;
...
import com.relylabs.instahelo.stories.StoryViewFragment;
...
public class StoryFeedFragment extends Fragment  implements  StoryFeedAdapter.StoryViewListener{
    ...
    private void createStory(Long story_id) {
        ...
        try {
            String path = "/storage/emulated/0/Android/data/com.relylabs.instahelo/files/";
