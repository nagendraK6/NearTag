...
import com.neartag.in.camera.DrawableImageView;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                root = "/storage/emulated/0/Android/data/com.neartag.in/files/";
               // File myDir = new File(root);
               // myDir.mkdirs();
                File file = new File("/storage/emulated/0/Android/data/com.neartag.in/files/temp_image.jpg");
                if (file.exists())
                    file.delete();
                try {
